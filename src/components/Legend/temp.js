...
const MainPage = () => {
  const [SugarCaneActive, SetSugarCaneActive] = useState(false);
  const [PotatoActive, SetPotatoActive] = useState(false);
  const [palmActive, SetpalmActive] = useState(false);
  const [ChilliActive, SetChilliActive] = useState(false);
  const [AlfalfaActive, SetAlfalfaActive] = useState(false);
  const [Barley, SetBarleyActive] = useState(false);
  const [CottonActive, SetCottonActive] = useState(false);
  const [CornActive, SetCornActive] = useState(false);
  const [SunflowerActive, SetSunflowerActive] = useState(false);
  const [WheatActive, SetWheatActive] = useState(false);
  ...
  const handleFileUpload = async (event) => {
    ...
    reader.onload = () => {
      ...
      setCoords([bboxarray[1], bboxarray[0]]);
                    ...
                    <li style={{}}>
                      <button
                        ...
                        style={{
                          ...
                          margin: "5px",
                          display: "flex",
                          background: SugarCaneActive ? "#4CB963" : "#1A2737",
                          border: "none",
                          borderRadius: 32,
                          fontFamily: "Red Hat Display",
                          color: "white",
